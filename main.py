...
async def main():
	global run, moving_left, moving_right, shoot, grenade, grenade_thrown, start_game, start_intro, screen_scroll, bg_scroll, level, world_data, player, health_bar, world
